...
from DeanerySystem.timetable import TimetableWithBreaks, TimetableWithoutBreaks, Action, Observer

Lesson.skipBreaks = True
x = TimetableWithBreaks([Break(9, 30, 5), Break(11, 5, 10), Break(12, 45, 5), Break(14, 20, 20), Break(16, 10, 5), Break(17, 45, 5), Break(19, 20, 5)])
